...
.innerHTML = `You <img src="images/${playerMove.toLowerCase()}-emoji.png"class="move-icon"> \t <img src="images/${computerMove.toLowerCase()}-emoji.png"class="move-icon"> Computer.`;
